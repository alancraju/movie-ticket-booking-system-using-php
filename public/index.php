	...
	<div class="wrap">
		<div class="content-top">
				<div class="listview_1_of_3 images_1_of_3">
					<h1 style="color:#000000;">UPCOMING MOVIES</h1>
					<?php 
				...
				<div class="content-left">
					<div class="listimg listimg_1_of_2">
						 <img src="../assets/<?php echo $n['attachment'];?>">
					</div>
					<div class="text list_1_of_2">
						  <div class="extra-wrap">
						  	<span style="text-color:#000000" class="data"><strong><?php echo $n['name'];?></strong><br>
						  	<span style="text-color:#000000" class="data"><strong>Cast :<?php echo $n['cast'];?></strong><br>
		...
		<?php include('../includes/movie_sidebar.php');?>
	</div>
</div>
